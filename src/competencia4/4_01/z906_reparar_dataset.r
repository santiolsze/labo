...
PARAM  <- list()
PARAM$experimento  <- "CA401" # Es la reparación de la v1 de la competencia 4.
#wget https://storage.googleapis.com/dmeyf2022/competenciaFINAL_2022.csv.gz  -O   ~/buckets/b1/datasets/competencia4_2022.csv.gz
