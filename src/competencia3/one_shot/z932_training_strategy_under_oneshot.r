...
PARAM  <- list()
PARAM$experimento <- "TS9321_OS" # ONE SHOT

PARAM$exp_input  <- "FE9250"

PARAM$future       <- c( 202107)

PARAM$final_train  <- c(202006,202007,202008,202009,
...
PARAM$train$undersampling_mayoritaria  <- 0.50  # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA

#Atencion, las semillas deben ser distintas
PARAM$train$semilla_sampling  <- 66697
