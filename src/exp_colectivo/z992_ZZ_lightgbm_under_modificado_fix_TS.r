...
PARAM  <- list()
PARAM$experimento  <- "ZZ9420" # Acá debe incluir meses, undersampling y semilla usada.
PARAM$exp_input  <- "HT9420" #Acá hay que cambiar el nombre para que sea el HT usado.
