...
PARAM$train$sampling_total  <- 0.01  # 1.0 significa que NO se hace sampling total,  0.3 es quedarse con el 30% de TODOS los registros
...
PARAM$experimento <- "TS9320_M08_US10_ST1"
