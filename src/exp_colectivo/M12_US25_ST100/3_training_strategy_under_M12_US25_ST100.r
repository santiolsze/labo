...
PARAM$final_train  <- c(202004,202005,202006,202007,202008,202009,202010,202011,202012,202101,202102,202103,202104,202105) # Tengo mis dudas, porque no vamos a poder validar nada.
...
PARAM$experimento <- "TS9320_M12_US25_ST100"
